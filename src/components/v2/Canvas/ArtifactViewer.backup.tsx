            ...
            {loadingRefs ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {references.map((ref, idx) => (
                  <div
                    key={idx}
                    className={`relative aspect-video rounded-2xl overflow-hidden border-2 transition-all group/ref ${landingState.selectedReferenceUrl === ref.url ? 'border-primary-color shadow-[0_0_20px_rgba(18,216,250,0.3)]' : 'border-white/5 hover:border-white/20'}`}
                  >
                    <img
                      src={ref.url}
                    ...
                    <div
                      className="absolute inset-0 bg-black/40 opacity-0 group-hover/ref:opacity-100 transition-opacity flex items-center justify-center cursor-pointer pointer-events-none"
                    >
